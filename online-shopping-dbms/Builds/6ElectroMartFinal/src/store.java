...
public class store extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Product Preview:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int i;
        Random randGen = new Random(20003);
        int add;
        add = randGen.nextInt(100);
        int add1;
        add1 = randGen.nextInt(100);
         for(i=0;i<table.getRowCount();i++)
        {
            ...
            pstmt.setString(1,login.id_public + add+add1);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        try{
            byte[] loc = rs.getBytes(1);
            ByteArrayInputStream byteInput = new ByteArrayInputStream(loc);
            BufferedImage image;
            image = ImageIO.read(byteInput);
            
            img.setText(null);
            img.setIcon(new ImageIcon(image.getScaledInstance(img.getHeight(),img.getWidth(),Image.SCALE_SMOOTH)));
